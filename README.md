...
# Pandas-Challenge
#### Program Code https://github.com/MichaelELeonard/pandas-challenge/blob/main/PyCitySchools/PyCitySchools_working_v2.ipynb
## Background Scenario 
...
* All the high performing Charters schools spent less dollars per student then the lowest performing District schools, showing that Charter schools were able to achieve higher scholastic performance at an overall reduced cost.
